...
<head>
    ...
    <link href="https://fonts.googleapps.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
...
<body class="bg-gradient-dark">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-xl-5 col-lgf-12 col-md-9">
    ...
    <script>
        @error('gagal') const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
